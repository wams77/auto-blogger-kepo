            ...
            for entry in feed.entries[:limit_per_sumber]:
                ...
                try:
                    ...
                    if not gambar_url:
                        ...
                        print(f"  > Gambar asli tidak ada. AI membuat ilustrasi gosip untuk judul ini.")
                except Exception as e:
...
def tulis_artikel_dengan_gemini(berita):
    ...
    2. Tulis isi artikel minimal 3 paragraf dengan gaya bahasa asyik (bisa menggunakan sedikit bahasa gaul populer tapi tetap rapi).
...
def main():
    ...
    for index, berita in enumerate(daftar_berita):
        ...
        if hasil_gemini:
            ...
            # 2. SISIPKAN KODE IKLAN ADSENSE DI BAWAH ARTIKEL
            kode_iklan = """
            <div style="margin-top: 30px; margin-bottom: 20px; text-align: center;">
                <!-- Auto Ads / Script Iklan -->
